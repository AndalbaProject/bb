...
const CONFIG = {
  ...
  letterSign: "-dari someone tengil paling jago, paling keren sedunia😎",

  // ---------- photo memories (pakai foto1..foto6 yang ada) ----------
  photos: [
    { img: "foto1.jpeg", cap: "may that beautiful smile continue to shine brightly on your face -g" },
    { img: "foto2.jpeg", cap: "immortalize all love in art" },
  ],
  ...
  // ---------- playlist ----------
  songs: [
    { title: "Dancing In The Kitchen", artist: "LANY", src: "song1.mp3" },
    { title: "Starting Over Again", artist: "Natalie Cole (and when I hold you in my arms, I promise you)", src: "song2.mp3" },
    { title: "Blessed", artist: "Daniel Caesar", src: "song3.mp3" },
  ],
  ...
  // ---------- final wish ----------
  wish: "another year older, but you'll always be my favorite plot twist. i hope this new chapter brings you endless everything u deserve. thank you for being the reason behind so many smiles, i am grateful every single day to know you bb",
};
...
function loadTrack(i, play) {
  ...
  const src = s.src || "Wonderwall.mp3";
...
function tryPlayMusic() {
  bgm.volume = 0.5;
  if (!bgm.currentSrc.endsWith("Wonderwall.mp3")) bgm.src = "Wonderwall.mp3";
